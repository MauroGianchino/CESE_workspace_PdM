...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, XLAT_Pin|LD2_Pin|MODE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : XLAT_Pin LD2_Pin MODE_Pin */
  GPIO_InitStruct.Pin = XLAT_Pin|LD2_Pin|MODE_Pin;
